	...
	<div style="margin:40px auto;">
		...
		<c:forEach items="${allMultiple }" var="multiple">
			<p style=" line-height: 20px;margin-left: 25px;">
				...
				<span style="font-family:'微软雅黑';font-szie:14px;">${multiple.question }<br/>
		...
		<c:forEach items="${allBlank }" var="blank">
			<p style=" line-height: 20px;margin-left: 25px;">
				...
				<span style="font-family:'微软雅黑';font-szie:14px;">${blank.question }
				</span>
			</p>
		</c:forEach>
		...
		<c:forEach items="${allJudge }" var="judge">
			<p style=" line-height: 20px;margin-left: 25px;">
				...
				<span style="font-family:'微软雅黑';font-szie:14px;">${judge.question }
				</span>
			</p>
		</c:forEach>
		...
		<c:forEach items="${allSubjective }" var="subjective">
			<p style=" line-height: 20px;margin-left: 25px;">
				...
				<span style="font-family:'微软雅黑';font-szie:14px;">${subjective.question }
				</span>
			</p>
		</c:forEach>
	</div>
